...
gateway to fetch and archive incident room messages. Since it doesn't use
...
logger = logging.getLogger("yiting.recorder_heartbeat")
            ...
            try:
                resp = await client.post(
                    ...
                    json={
                        "role": "recorder",
                        "agent_id": agent_id,
                        "framework": "local incident-room runtime",
                        "model": "deterministic",
                    },
