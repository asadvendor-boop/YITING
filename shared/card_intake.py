"""YITING Card Intake Helpers — Shared extraction and validation functions.
...
logger = logging.getLogger("yiting.card_intake")
...
def derive_idempotency_key(
    ...
    duplicate. This is safe for incident room's at-least-once delivery.
