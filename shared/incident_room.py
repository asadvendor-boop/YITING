"""Gateway-owned Incident Room client.

This is the replacement collaboration transport for the Alibaba/Qwen version.
...
class IncidentRoomClient:
    """Async client for Gateway-managed incident rooms."""
    ...
    async def create_room(self, title: str, incident_id: str | None = None) -> str:
        response = await self.client.post(
            "/rooms",
            json={"title": title, "incident_id": incident_id},
        )
